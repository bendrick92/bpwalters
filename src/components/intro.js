    ...
    <>
      ...
      <Fade>
        <div>
          ...
          <p>If you have any questions about my <AnchorLink to='#projects'>projects</AnchorLink> or would like to work together, find me on <a href='https://github.com/bendrick92' target='_blank'>Github</a> or <a href='mailto:contact@bpwalters.com'>shoot me an email</a>!</p>
        </div>
      </Fade>
    </>
  );
